...
export default function Home({propertiesForSale, propertiesForRent}) {
  return (
    <Box>
      ...
      />
      <Flex flexWrap="wrap">{propertiesForRent.map((property) => <Property key={property.id} property={property} />)}</Flex>
      <Banner
        purpose="BUY A HOME"
        ...
        imageUrl="https://via.placeholder.com/500x300.png?text=Visit+reactrealtors.com+Now"
      />
      <Flex flexWrap="wrap">{/* Fetch properties for sale and map over them... */}</Flex>
    </Box>
  );
}
